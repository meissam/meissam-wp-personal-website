...
$wizard = new Merlin(
	$config = array(
		...
		'parent_slug'          => '', // The wp-admin parent page slug for the admin menu item.
	...
	$strings = array(
		...
		'child-success%s'          => esc_html__( 'Your child theme has already been installed and is now activated.', '@@textdomain' ),
		...
		'ready-link-2'             => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'customize.php' ), esc_html__( 'Start Customizing', '@@textdomain' ) ),
	)
);
