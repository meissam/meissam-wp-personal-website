...
class My_meta_box {
    ...
    function __construct($meta_box) {
        ...
        add_action('admin_menu', array(&$this, 'eris_add'));
        add_action('save_post', array(&$this, 'eris_save'));
    } // end __construct
    ...
    function eris_add() {
        foreach ($this->_meta_box['pages'] as $page) {
            add_meta_box($this->_meta_box['id'], $this->_meta_box['title'], array(&$this, 'eris_show'), $page, $this->_meta_box['context'], $this->_meta_box['priority']);
        }
    } // close add
            ...
            switch ($field['type']) {
                ...
                case 'select-advertising':
                    ...
                    if (!empty($query_ad_posts)) {
                        echo '<option value="none">'.esc_html__('None', 'eris').'</option>';
                        ...
                        echo '<option value="none" selected="selected">'.esc_html__('None', 'eris').'</option>';
                    }
                    echo '</select></br>';
                    echo '<span class="description">' . $field['desc'] . '</span>';
                ...
                /************************************************************/
                case 'repeatable':
                    echo '<small>' . esc_html__( 'Drag to reorder images', 'eris' ) . '</small>';
                    ...
                    echo '<a class="repeatable-add button" href="#">+</a> <span class="add-repeatable">' . esc_html__( 'Click to add another meta box', 'eris' ) . '</span>';
                    break;
                ...
                case 'additional_info':
                    ...
                    if ($meta) {
                        foreach ($meta as $row) {
                            ...
                            echo '<li>
                                    ' . esc_html__('Title:  ', 'eris') . '<input type="text"  class="upload-url"  name="title-' . $field['id'] . '[' . $i . ']" id="title-' . $field['id'] . '"  value="' . $additional_title[$i] . '" size="30" style="width:20%" />
                                    ' . esc_html__('Text:  ', 'eris') . '<input type="text"  class="upload-url"  name="content-' . $field['id'] . '[' . $i . ']" id="content-' . $field['id'] . '"  value="' . $additional_content[$i] . '" size="30" style="width:40%" />
                        ...
                        echo '<li>
                                ' . esc_html__('Title:  ', 'eris') . '<input type="text"  class="upload-url"  name="title-' . $field['id'] . '[' . $i . ']" id="title-' . $field['id'] . '"  size="30" style="width:20%" />
                                ' . esc_html__('Text:  ', 'eris') . '<input type="text"  class="upload-url"  name="content-' . $field['id'] . '[' . $i . ']" id="content-' . $field['id'] . '"  size="30" style="width:40%" />
